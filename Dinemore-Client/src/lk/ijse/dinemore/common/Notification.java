...
public class Notification {
    ...
    public static void createError(String title, String text) {
        createCustom(title, text, "lk/ijse/dinemore/assests/icons8-delete-100.png");
    }

    public static void createSuccesful(String title, String text) {
        createCustom(title, text, "lk/ijse/dinemore/assests/icons8-ok-100.png");
    }

    public static ButtonType createConfigAlert() {
        Alert remaining = new Alert(Alert.AlertType.CONFIRMATION);

        remaining.setGraphic(new ImageView(new Image("lk/ijse/dinemore/assests/icons8-error-100.png")));
